...
public class WCTest {
    ...
    public void wordCountTest1() {
        //Given
        WC wordCountTest1 = new WC(WC.class.getResource("/someTextFile.txt").getFile());

        //When
        String expected = "{at=1, car=2, day=1, he=1, say=1, the=1}";
        String actual = wordCountTest1.storeWordsAndCount().toString();
    ...
    public void wordCountTest2() {
        //Given
        WC wordCountTest1 = new WC(WC.class.getResource("/someTextFile2.txt").getFile());
    ...
    public void sortedByValue1() {
        ...
        String actual = wordCountTest1.sortedByValueDescending(wordCountTest1.storeWordsAndCount()).toString();
    ...
    public void sortedByValue2() {
        //Given
        WC wordCountTest1 = new WC(WC.class.getResource("/someTextFile3.txt").getFile());
